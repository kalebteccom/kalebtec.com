...
export const graphaware: ProjectSeedData = {
  ...
  client: 'GraphAware',
  description:
    'Contracted as Senior Software Engineer on the analytics suite of GraphAware\'s Hume platform, a Neo4j-powered graph application. Designed and built features in Vue.js against Neo4j and wrote end-to-end tests for a canvas-based web graph editor using Playwright for Java.',
  ...
  content: buildRichText([
    h2('Overview'),
    p(
      "GraphAware specializes in graph-powered analytics and knowledge management. Hume, their flagship platform, helps organizations extract insights from complex, interconnected data using Neo4j graph databases. Rowin joined as a contract Senior Software Engineer working on the analytics suite.",
    ),
  ...
  translations: {
    es: {
      ...
      content: buildRichText([
        ...
        p('GraphAware se especializa en analítica basada en grafos y gestión del conocimiento. Hume, su plataforma insignia, ayuda a las organizaciones a extraer insights de datos complejos e interconectados usando bases de datos de grafos Neo4j. Rowin se incorporó como Contractor — Senior Software Engineer trabajando en la suite de analítica.'),
    ...
    fr: {
      ...
      content: buildRichText([
        h2('Vue d\'ensemble'),
        p("GraphAware est spécialisée dans l'analytique basée sur les graphes et la gestion des connaissances. Hume, leur plateforme phare, aide les organisations à extraire des insights de données complexes et interconnectées en utilisant les bases de données graphe Neo4j. Rowin est intervenu comme Contractor — Senior Software Engineer sur la suite analytique."),
    ...
    gl: {
      ...
      content: buildRichText([
        h2('Descrición Xeral'),
        p('GraphAware especialízase en analítica baseada en grafos e xestión do coñecemento. Hume, a súa plataforma insignia, axuda ás organizacións a extraer insights de datos complexos e interconectados usando bases de datos de grafos Neo4j. Rowin incorporouse como Contractor — Senior Software Engineer traballando na suite de analítica.'),
    ...
    pt: {
      ...
      content: buildRichText([
        h2('Visão Geral'),
        p('A GraphAware especializa-se em analytics baseada em grafos e gestão de conhecimento. A Hume, a sua plataforma principal, ajuda as organizações a extrair insights de dados complexos e interligados usando bases de dados de grafos Neo4j. Rowin integrou-se como Contractor — Senior Software Engineer a trabalhar na suite de analytics.'),
