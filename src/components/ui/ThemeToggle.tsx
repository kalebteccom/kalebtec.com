    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          ...
          align="end"
        >
          <div className="px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.25em] text-cyber-faint select-none" aria-hidden="true">
            [THEME]
          </div>
          ...
          <div className="mx-3 mt-1 mb-1 h-px bg-gradient-to-r from-transparent via-brand/30 to-transparent" aria-hidden="true" />
        </DropdownMenu.Content>
      </DropdownMenu.Portal>
    </DropdownMenu.Root>
  )
