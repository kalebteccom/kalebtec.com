    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-2xl">
        ...
        <div className="flex items-center gap-2 mb-6">
          <span className="font-mono text-sm text-red-400 tracking-wider">{t('label')}</span>
        ...
        <div className="mt-8 w-full max-w-md border border-red-500/20 bg-cyber-surface p-4 text-left cyber-corners">
          <div className="font-mono text-[11px] text-cyber-faint space-y-1.5">
            <p>
              <span className="text-cyber-muted">[DIAG]</span> {t('diagProcess')}
            </p>
            <p>
            ...
            <p>
              <span className="text-brand-light">[INFO]</span> {t('diagRecovery')}
            </p>
            <p className="text-cyber-faint/60 typing-cursor">{t('diagAwaiting')}</p>
          </div>
        </div>
